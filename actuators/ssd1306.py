...
class SSD1306(framebuf.FrameBuffer):
    ...
    def init_display(self):
        for cmd in (
            ...
            SET_DISP_OFFSET, 0x00, SET_COM_PIN_CONFIG, 0x02 if self.width == 128 and self.height == 32 else 0x12,
...
if __name__ == "__main__":
    ...
    display.fill(0)
    display.text("ESP8266 Active!", 0, 0)
    display.text("MicroPython", 0, 16)
    display.text("OLED Display", 0, 32)
